...
/** Instagram manzilingizni shu yerga yozing */
const IG_URL = 'https://instagram.com/isft_samarqand' // TODO: o'zingiznikiga almashtiring
      ...
      <div className="w-full max-w-lg">
        <div className="rounded-3xl border bg-white shadow-sm p-8 text-center">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a
              href="/"
              className="inline-block rounded-xl border border-zinc-300 px-5 py-3"
            >
